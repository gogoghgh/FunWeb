...
public class FileBoardUpdateAction implements Action {

	@Override
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		System.out.println("(from FileBoardUpdateAction) M: execute() 메서더 호출됨");
		...
		System.out.println("(from FileBoardUpdateAction) M: 조회수 +1 완");
		...
		forward.setPath("./center/fupdate.jsp");
